...
function custom_gf_css() {
	...
	wp_enqueue_style( 'css_inscripcion', plugins_url( '', __FILE__ ) . '/css/encuesta_presupuestos.css');
...
function custom_gf_js() {
	...
	wp_enqueue_script('js_inscripcion',  plugins_url( '', __FILE__ ) . '/js/encuesta_presupuestos.js', array(), '1.0', true);
}