...
function theme_enqueue_styles() {
	...
	wp_enqueue_script('tooltip', get_stylesheet_directory_uri() . '/js/jquery.tooltipster.min.js', array(), '1.0', true);

	wp_enqueue_script('remodal',  get_stylesheet_directory_uri() . '/js/remodal.min.js', array(), '1.0', true);
	
	wp_enqueue_script('scrollTo',  get_stylesheet_directory_uri() . '/js/jquery.scrollTo.min.js', array(), '1.0', true);
	
	wp_enqueue_style( 'tooltip_css', get_stylesheet_directory_uri() . '/css/tooltipster.css' );
...
function custom_enqueue_gf_css() {
	wp_enqueue_style( 'css_presupuestos', get_stylesheet_directory_uri() . '/css/encuesta_presupuestos.css' );
	wp_enqueue_style( 'css_presupuestos_movil', get_stylesheet_directory_uri() . '/css/encuesta_presupuestos_movil.css' );
...
function custom_enqueue_gf_js() {
	wp_enqueue_script('javascript_post_gform',  get_stylesheet_directory_uri() . '/js/encuesta_presupuestos.js', array(), '1.0', true);
}
